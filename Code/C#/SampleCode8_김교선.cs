...
public class UIDialogChargeShop : ManualSingletonUIDialog<UIDialogChargeShop>
{
    ...
    [SerializeField]
    private UIToggle[] _btnTaps;
    [SerializeField]
    private UIItemList[] _itemList; // 티켓이 아이템이 달라서 사용
    [SerializeField]
    private UIState _stateItemList;
    [SerializeField]
    private UILabel _labelStamina;
    [SerializeField]
    private UILabel _labelGold;
    [SerializeField]
    private UILabel _labelCash;
    [SerializeField]
    private UILabel _labelNationCoin;
    [SerializeField]
    private UILabel _labelEmpty;
    [SerializeField]
    private UILabel _labelRealCash;
    [SerializeField]
    private UILabel _labelWarning;
